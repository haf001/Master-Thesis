...
def run_solver():
    ...
    # Evaluating and projecting the Darcy velocity profile, u_bar
    w_1 = -K*grad(p)
...
def iterate_solver():
    "Iterating solver to produce Pressure p = sin(x)*sin(y) over diffeent mesh sizes and generating plots"
