...
def solver(f, K1_val, K2_val, K3_val, b_12_val, b_23_val, mesh, degree):
    """
    ...
    Beta_12 = Constant value 0.50, Beta_23 = Constant value 0.50
    """
...
def run_solver():
    ...
    p = solver((f1, f2, f3), K_1, K_2, K_3, b_12_val, b_23_val, mesh, 2)
